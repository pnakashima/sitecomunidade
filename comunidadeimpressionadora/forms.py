...
class FormCriarConta(FlaskForm):
    ...
    def validate_email(self, email):  # a opcao validate_on_submit (routes.py) executa todas as funcoes q começam com "validate_"
...
class FormLogin(FlaskForm):
    ...
    botao_submit_login = SubmitField('Fazer Login', validators=[])
